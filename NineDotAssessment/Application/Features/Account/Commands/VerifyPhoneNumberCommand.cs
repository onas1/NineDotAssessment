...
public class VerifyPhoneNumberCommand: IRequest<BaseResponse<OtpVerificationResult>>
{
...
public class VerifyPhoneNumberCommandHandler : IRequestHandler<VerifyPhoneNumberCommand, BaseResponse<OtpVerificationResult>>
{
    private readonly IApplicationDbContext _dbContext;
    private readonly IMediator _mediator;

    public VerifyPhoneNumberCommandHandler(IApplicationDbContext dbContext, IMediator mediator)
    {
    ...
    public async Task<BaseResponse<OtpVerificationResult>> Handle(VerifyPhoneNumberCommand request, CancellationToken cancellationToken)
    {
        ...
        if (oneTimePassword == null || !oneTimePassword.IsValid || oneTimePassword.VerificationType != OtpType.PhoneNumberVerification)
        {
        ...
        {
            var successfulPhoneVerificationEvent = new PhoneNumberVerificationEvent(user, oneTimePassword);
            await _mediator.Publish(successfulPhoneVerificationEvent, cancellationToken);
